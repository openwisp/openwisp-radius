...
class RadiusAccountingSerializer(serializers.ModelSerializer):
    ...
    def get_start_time_display(self, obj):
        value = obj.get("start_time") if isinstance(obj, dict) else obj.start_time
        return self._get_localized_datetime(value)

    def get_stop_time_display(self, obj):
        value = obj.get("stop_time") if isinstance(obj, dict) else obj.stop_time
        return self._get_localized_datetime(value)
