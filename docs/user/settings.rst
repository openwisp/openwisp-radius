...
- ``pending_verification``: Transitional state used when a user authenticates
  to a new organization but has not yet completed verification for that organization.
