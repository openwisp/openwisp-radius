...
Supported timeseries databases
------------------------------

The charts above are defined for InfluxDB 1.8, InfluxDB 2.x and
Elasticsearch and are selected automatically according to the
``TIMESERIES_DATABASE`` setting of the project: no chart specific
